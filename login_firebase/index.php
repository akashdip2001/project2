...
<div id="leaves">
  ...
  <i></i> 
    ...
    <div class="button-container">
        ...
        <button onclick="showImages()" style="font-weight: bold;font-size: 18px;" class="button">Show Images</button>
        ...
        <a style="font-weight: bold;font-size: 20px;" href="index.html" class="button">Sign Up & Login </a>
        
        <!-- <a style="font-weight: bold;font-size: 18px;" href="Policy.html" class="policy">Terms of Service</a> -->
    </div>
